...
<!--End of Tawk.to Script-->
	...
	<div class="preloader"><h1 class="loadtext">mohon tunggu....</h1><br>
	<h2 class="loadtext2">Terlalu lambat? <a class="linkusual" href="basic.php">Load the basic!</a></h2>
	</div>
		<!-- Header -->
				...
				<div class="inner">
					<div class="grid-style">
						...
						<div>
							<div class="box">
								<div class="image fit">
									<img src="image copy.png" style="height:450px;" alt="" />
								</div>
								<div class="content">
									<header class="align-center">
										<p>Baca Selengkapnya</p>
										<h2>stmik kaputama</h2>
									</header>
									<p>Sekolah Tinggi Manajemen Informatika dan Komputer Kaputama TERAKREDITASI "B" BAN-PT NO. 206/SK/BAN-PT/Akred/PT/IV/2019. Sebagai Sekolah Tinggi Manajemen Informatika dan Komputer, STMIK Kaputama memberikan perhatian khusus terhadap kegiatan-kegiatan penelitian serta mendorong dosen dan mahasiswa untuk melakukan dan mengembangkan berbagai penelitian yang berorientasi untuk memenuhi kebutuhan bangsa. Sebagai Sekolah Tinggi Manajemen Informatika dan Komputer, STMIK Kaputama memberikan perhatian khusus terhadap kegiatan-kegiatan pengabdian serta mendorong dosen dan mahasiswa untuk melakukan dan mengembangkan berbagai pengabdian yang berorientasi untuk memenuhi kebutuhan bangsa.
									</p>
									<footer class="align-center">
										<a target="_blank" href="https://id.linkedin.com/company/stmik-kaputama" class="button alt">Lebih Lengkap</a>
									</footer>
								</div>
							</div>
						</div>
		...
		<!-- Three -->
			<section id="three" class="wrapper style2">
				<div class="inner">
					...
					<div class="gallery">
						<div>
							<div class="image fit">
							<a href="" target="_body"><img src="" alt="" /></a>
							</div>
						</div>
						<div>
							<div class="image fit">
						...
						<div>
							<div class="image fit">
							<a href="" target="_body"><img src="" alt="" id="modalpic3"/></a>
							</div>
						</div>
						<div>
							<div class="image fit">
							<a href="" target="_body"><img src="" alt="" id="modalpic4" /></a>
							</div>
						</div>
					</div>
				</div>
			...
			<footer id="footer">
				<p style="color:white">stmik kaputama binjai</p>
				<div class="container">
					<ul class="icons">
						<li><a href="https://www.instagram.com/stmikkaputama_official/" class="icon fa-instagram"><span class="label">Instagram</span></a></li>
						<li><a href="https://github.com/slims" class="icon fa-github"><span class="label">Github</span></a></li>
						<li><a href="https://www.facebook.com/share/15vhhR9NML/?mibextid=LQQJ4d" class="icon fa-facebook"><span class="label">facebook</span></a></li>					</ul>
				</div>
				<div class="copyright">
